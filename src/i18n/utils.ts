...
const translations: Record<Locale, TranslationMap> = {
  en: { ...enCommon, ...enHome, ...enTools, ...enResizer, ...enCmMm, ...enPan, ...enWa, ...enSsc, ...enYt, ...enB64, ...enDataUri },
  es: { ...esCommon, ...esHome, ...esTools, ...esResizer, ...esCmMm, ...esPan, ...esWa, ...esSsc, ...esYt, ...esB64, ...esDataUri },
  pt: { ...ptCommon, ...ptHome, ...ptTools, ...ptResizer, ...ptCmMm, ...ptPan, ...ptWa, ...ptSsc, ...ptYt, ...ptB64, ...ptDataUri },
  fr: { ...frCommon, ...frHome, ...frTools, ...frResizer, ...frCmMm, ...frPan, ...frWa, ...frSsc, ...frYt, ...frB64, ...frDataUri },
  de: { ...deCommon, ...deHome, ...deTools, ...deResizer, ...deCmMm, ...dePan, ...deWa, ...deSsc, ...deYt, ...deB64, ...deDataUri },
  id: { ...idCommon, ...idHome, ...idTools, ...idResizer, ...idCmMm, ...idPan, ...idWa, ...idSsc, ...idYt, ...idB64, ...idDataUri },
  tr: { ...trCommon, ...trHome, ...trTools, ...trResizer, ...trCmMm, ...trPan, ...trWa, ...trSsc, ...trYt, ...trB64, ...trDataUri },
  it: { ...itCommon, ...itHome, ...itTools, ...itResizer, ...itCmMm, ...itPan, ...itWa, ...itSsc, ...itYt, ...itB64, ...itDataUri },
};
