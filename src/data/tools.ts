...
export const TOOL_SLUGS: Record<string, Record<Locale, string>> = {
  ...
  'batch-rename-images': {
    ...
    pt: 'renomear-imagens-em-lote',
    fr: 'renommer-images-en-masse',
    de: 'bilder-im-batch-umbenennen',
    id: 'ubah-nama-gambar-masal',
  ...
  'image-srcset-generator': {
    ...
    pt: 'gerador-de-srcset-de-imagens',
    fr: 'generateur-srcset-images',
    de: 'image-srcset-generator-online',
    id: 'generator-srcset-gambar',
    tr: 'resim-srcset-olusturucu',
    it: 'generatore-srcset-immagini',
  },
  'passport-photo-maker': {
    en: 'passport-photo-maker',
    es: 'creador-fotos-tamano-pasaporte',
    pt: 'criador-de-foto-tipo-passe',
    fr: 'createur-photo-identite-passeport',
    de: 'passfoto-generator-online',
    id: 'pembuat-pas-foto-paspor',
    tr: 'biyometrik-vesikalik-fotograf-yapici',
    it: 'creatore-fototessera-online',
  },
  'gif-frame-extractor': {
    en: 'gif-frame-extractor',
    es: 'extractor-de-fotogramas-gif',
    pt: 'extrator-de-quadros-de-gif',
    fr: 'extracteur-d-images-gif',
    de: 'gif-einzelbilder-extrahieren',
    id: 'ekstrak-frame-gif',
    tr: 'gif-kare-cikarici',
    it: 'estrattore-di-fotogrammi-gif',
  },
  'image-to-text-converter': {
    en: 'image-to-text-converter',
    es: 'convertidor-imagen-a-texto',
    pt: 'conversor-imagem-para-texto',
    fr: 'convertisseur-image-en-texte',
    de: 'bild-in-text-umwandeln',
    id: 'pengubah-gambar-ke-teks',
    tr: 'resimden-yaziya-donusturucu',
    it: 'convertitore-immagine-in-testo',
  },
  'image-dpi-converter': {
    en: 'image-dpi-converter',
    es: 'convertidor-dpi-imagen',
    pt: 'conversor-dpi-imagem',
    fr: 'convertisseur-dpi-image',
    de: 'bild-dpi-aendern',
    id: 'pengubah-dpi-gambar',
    tr: 'resim-dpi-donusturucu',
    it: 'convertitore-dpi-immagine',
  },
  'svg-resizer': {
    en: 'svg-resizer',
    es: 'redimensionar-svg',
    pt: 'redimensionar-svg',
    fr: 'redimensionner-svg',
    de: 'svg-skalieren',
    id: 'ubah-ukuran-svg',
    tr: 'svg-boyutlandirma',
    it: 'ridimensiona-svg',
  },
  ...
  'facebook-cover-resizer': {
    ...
    pt: 'redimensionar-capa-facebook',
    fr: 'redimensionner-couverture-facebook',
    de: 'facebook-titelbild-groesse-anpassen',
    id: 'ubah-ukuran-sampul-facebook',
    tr: 'facebook-kapak-fotografi-boyutlandirma',
    it: 'ridimensiona-copertina-facebook',
  },
  'youtube-thumbnail-resizer': {
    en: 'youtube-thumbnail-resizer',
    es: 'redimensionar-miniatura-youtube',
    pt: 'redimensionar-miniatura-youtube',
    fr: 'redimensionner-miniature-youtube',
    de: 'youtube-thumbnail-groesse-anpassen',
    id: 'ubah-ukuran-thumbnail-youtube',
    tr: 'youtube-kucuk-resim-boyutlandirma',
    it: 'ridimensiona-miniatura-youtube',
  },
  ...
  'seo-image-filename-generator': {
    en: 'seo-image-filename-generator',
    es: 'generador-nombres-archivo-seo-imagenes',
    pt: 'gerador-nome-arquivo-seo-imagens',
    fr: 'generateur-nom-fichier-seo-images',
    de: 'seo-bild-dateinamen-generator',
    id: 'generator-nama-file-gambar-seo',
    tr: 'seo-resim-dosya-adi-olusturucu',
    it: 'generatore-nomi-file-seo-immagini',
  },
  'whatsapp-photo-compressor': {
    en: 'whatsapp-photo-compressor',
    es: 'compresor-de-fotos-de-whatsapp',
    pt: 'compressor-de-fotos-do-whatsapp',
    fr: 'compresseur-de-photos-whatsapp',
    de: 'whatsapp-foto-komprimierer',
    id: 'kompres-foto-whatsapp',
    tr: 'whatsapp-fotograf-sikistirma',
    it: 'comprimi-foto-whatsapp',
  },
};
...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    icon: 'image',
    category: 'resize',
    titleKey: 'tools.facebookCoverResizer.title',
    descKey: 'tools.facebookCoverResizer.description',
    keywords: ['facebook', 'cover photo', '820x312', '1640x720', 'safe zone', 'fb banner', 'facebook page cover', 'facebook group cover', 'facebook event banner', 'resizer', 'dimensions'],
    badge: 'POPULAR',
    isActive: true,
  },
  {
  ...
  
  {
    ...
    icon: 'code',
    category: 'resize',
    titleKey: 'tools.imageSrcsetGenerator.title',
    descKey: 'tools.imageSrcsetGenerator.description',
    keywords: ['image srcset generator', 'srcset generator', 'responsive image generator', 'html srcset generator', 'generate srcset code', 'responsive images html', 'image sizes attribute', 'picture element generator'],
    badge: 'NEW',
    isActive: true,
  },
  {
    ...
    icon: 'user-check',
    category: 'resize',
    titleKey: 'tools.passportPhotoMaker.title',
    descKey: 'tools.passportPhotoMaker.description',
    keywords: ['passport photo maker', 'passport size photo maker online', 'free passport photo maker', 'passport photo sheet', 'make passport photo at home', 'printable passport photos', 'visa photo maker', 'biometric photo maker', '4x6 passport photo sheet'],
    badge: 'NEW',
    isActive: true,
  },
  {
    ...
    icon: 'film',
    category: 'convert',
    titleKey: 'tools.gifExtractor.title',
    descKey: 'tools.gifExtractor.description',
    keywords: ['gif frame extractor', 'extract frames from gif', 'gif to frames', 'split gif', 'gif frames', 'animated gif', 'gif to png', 'save gif frames', 'gif splitter'],
    badge: 'NEW',
    isActive: true,
  },
  {
    ...
    icon: 'file-text',
    category: 'convert',
    titleKey: 'tools.imageToText.title',
    descKey: 'tools.imageToText.description',
    keywords: ['image to text converter', 'image to text', 'extract text from image', 'ocr online', 'convert image to text', 'photo to text', 'jpg to text', 'png to text', 'free ocr'],
    badge: 'NEW',
    isActive: true,
  },
  {
    ...
    icon: 'sliders',
    category: 'resize',
    titleKey: 'tools.dpiConverter.title',
    descKey: 'tools.dpiConverter.description',
    keywords: ['image dpi converter', 'change image dpi', 'convert dpi online', 'increase image dpi', 'reduce image dpi', 'change photo dpi', 'image resolution dpi', '300 dpi converter', '600 dpi', 'print size calculator'],
    badge: 'NEW',
    isActive: true,
  },
  {
    ...
    icon: 'vector',
    category: 'resize',
    titleKey: 'tools.svgResizer.title',
    descKey: 'tools.svgResizer.description',
    keywords: ['svg resizer', 'resize svg online', 'svg image resizer', 'resize svg without losing quality', 'svg dimensions', 'svg width and height', 'online svg resizer', 'scale svg', 'vector resizer', 'viewbox resizer', 'svg to png'],
    badge: 'NEW',
    isActive: true,
  },
  {
    ...
    icon: 'youtube',
    category: 'resize',
    titleKey: 'tools.youtubeThumbnailResizer.title',
    descKey: 'tools.youtubeThumbnailResizer.description',
    keywords: ['youtube', 'thumbnail', '1280x720', '16:9', 'cover', 'video thumbnail', 'resizer', 'yt thumbnail maker', 'dimensions'],
    badge: 'POPULAR',
    isActive: true,
  },
  {
  ...
  {
    id: 'seo-image-filename-generator',
    icon: 'tag',
    category: 'edit',
    titleKey: 'tools.seoFilenameGenerator.title',
    descKey: 'tools.seoFilenameGenerator.description',
    keywords: ['seo image filename generator', 'seo friendly image filenames', 'rename image for seo', 'image filename generator', 'seo image naming', 'descriptive image filenames', 'image seo renamer', 'image seo name', 'optimize image filename'],
    badge: 'NEW',
    isActive: true,
  },
  {
    id: 'whatsapp-photo-compressor',
    icon: 'zap',
    category: 'compress',
    titleKey: 'tools.whatsappCompressor.title',
    descKey: 'tools.whatsappCompressor.description',
    keywords: ['whatsapp photo compressor', 'compress photo for whatsapp', 'compress image for whatsapp', 'reduce photo size for whatsapp', 'reduce image size for whatsapp', 'whatsapp image compressor', 'compress jpg for whatsapp', 'compress png for whatsapp', 'reduce photo file size', 'compress image to 100kb', 'send high quality photos on whatsapp', 'make photo smaller for whatsapp'],
    badge: 'NEW',
    isActive: true,
  },
];
